...
- Audible reinforcement via native text-to-speech on sentence completion, with a Listen Again control, and a Voice setting that lists the device's Mandarin voices by name and accent, each with a sample
